...
struct GridwiseGemm_bk0mk1_bk0nk1_mn_xdlops_v2r4r2
{
    ...
    __host__ __device__ static constexpr auto
    MakeCBlockClusterAdaptor(const CGridDesc_MBlock_MPerBlock_NBlock_NPerBlock&
                                 c_grid_desc_mblock_mperblock_nblock_nperblock,
                             index_t M01,
                             index_t N01,
                             index_t KBatch)
    {
        return BlockToCTileMap_KSplit_M00_N00_M01_N01<
            CGridDesc_MBlock_MPerBlock_NBlock_NPerBlock>(
            c_grid_desc_mblock_mperblock_nblock_nperblock, M01, N01, KBatch);
    }
    ...
    using CBlockClusterAdaptor =
        decltype(MakeCBlockClusterAdaptor(CGridDesc_MBlock_MPerBlock_NBlock_NPerBlock{}, 1, 1, 1));
