...
struct GridwiseBatchedGemmGemm_Xdl_CShuffle
{
                               ...
                               const Block2CTileMap& block_2_ctile_map)
    {
        ...
        auto blockwise_softmax =
            BlockwiseSoftmax_V1<BlockSize,
                                FloatGemmAcc,
        ...
        using SoftmaxBuf = decltype(blockwise_softmax.max_value_buf);
        SoftmaxBuf running_sum;
        running_sum.Clear();
        SoftmaxBuf running_sum_new;
        running_sum_new.Clear();
        SoftmaxBuf running_max;
        running_max.Set(NumericLimits<FloatGemmAcc>::Lowest());
        SoftmaxBuf running_max_new;
        running_max_new.Set(NumericLimits<FloatGemmAcc>::Lowest());
