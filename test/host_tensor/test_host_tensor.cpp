...
TEST(HostTensor, TestTransposeBadArugment)
{
...
TEST(HostTensor, TestTranspose2D)
{
...
TEST(HostTensor, TestTranspose3D)
{
...
TEST(HostTensor, TestTranspose3D_021)
{
    std::vector<size_t> lengths  = {13, 7, 5};
...
TEST(HostTensor, TestTransposeNonpacked2D)
{
    std::vector<size_t> lengths  = {13, 7};
