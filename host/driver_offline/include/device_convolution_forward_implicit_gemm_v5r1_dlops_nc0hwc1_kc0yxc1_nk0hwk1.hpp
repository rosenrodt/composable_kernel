    ...
    ck::index_t nrepeat)
{
    ...
    constexpr index_t ABlockTransferSrcScalarPerVector_E2  = 4;
    constexpr index_t ABlockTransferDstScalarPerVector_E2  = 4;
    constexpr index_t BThreadTransferSrcScalarPerVector_E2 = 4;
