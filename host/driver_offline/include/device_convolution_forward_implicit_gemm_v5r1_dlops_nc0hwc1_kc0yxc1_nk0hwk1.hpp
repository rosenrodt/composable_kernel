    ...
    ck::index_t nrepeat)
{
    ...
    using ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2   = Sequence<E0PerBlock, 6, 1, 1, C1>;
    using ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2 = Sequence<1, 3, 1, KPerBlock, 1>;
    ...
    using ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2   = Sequence<1, 9, 1, 1, C1>;
    using ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2 = Sequence<1, 1, 1, KPerBlock, 1>;
