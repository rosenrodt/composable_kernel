...
int main()
{
    ...
    // clang-format off
    // BlockToCTileMap_M00_N00_M01_N01<MPerBlock, NPerBlock, decltype(c_grid_desc_m0_m1_n0_n1)> tile_map(c_grid_desc_m0_m1_n0_n1, 2, 2);
    // BlockToCTileMap_N00_M0_N01Adapt<MPerBlock, NPerBlock, decltype(c_grid_desc_m0_m1_n0_n1)> tile_map(c_grid_desc_m0_m1_n0_n1, 4);
    BlockToCTileMap_M00_N0_M01Adapt<MPerBlock, NPerBlock, decltype(c_grid_desc_m0_m1_n0_n1)> tile_map(c_grid_desc_m0_m1_n0_n1, 4);
    // clang-format on
